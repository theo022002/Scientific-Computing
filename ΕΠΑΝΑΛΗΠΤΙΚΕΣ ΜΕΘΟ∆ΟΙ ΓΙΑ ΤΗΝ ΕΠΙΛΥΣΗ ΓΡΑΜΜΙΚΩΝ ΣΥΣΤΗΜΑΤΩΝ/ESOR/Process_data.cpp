...
double random_number(double a, double b)                                            //Ftiaxnei double tuxaious arithmous sto diasthma [a,b]
{
    random_device rd;
    mt19937 gen(rd());
...
void createA(vector<vector<long double>> &A , double a, double b, double c, double d, int n)  //Ftiaxnoume ton A gia sugkekrimeena a,b,c,d
{
    for(int i = 0; i < n; i++)
    {   
        for(int j = 0; j < n; j++)
