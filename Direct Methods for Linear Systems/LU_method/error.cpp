...
vector<vector<long double>> inverse(vector<vector<long double>> matrix)                                                //Ypologizei ton Actual inverse tou pinaka A - Pei
{
    int n = matrix.size();
...
vector<vector<long double>> A_inv_actual;
...
void Error_residual_inverse(vector<vector<long double>> A, vector<vector<long double>> A_inverse)                      //Ypologizei to apoluto sxetiko upoloipo kai sfalma ston upologissmo tou antistrofou 
{
    ...
    A_inv_actual = inverse(A);                                                                                         //Ypologizei ton actual inverse tou A
