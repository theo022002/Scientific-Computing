...
int main(void) 
{
    ...
    for (double omega = omega_min; omega <= omega_max; omega += omega_step)                        // Epanalambanoume gia oles tis times tou omega
    {
        ...
        {
            vector<long double> solution = ESOR(A, b, omega, tau, 0);                              // Lunoume to susthma me thn ESOR methodo
            double error = 0.0;
    ...
    vector<long double> solution = ESOR(A, b, omega_optimal, tau_optimal, 1);                      // Lunoume to susthma me tis beltistes times twn w,t
    cout << "Solution:" << endl;                                                          
