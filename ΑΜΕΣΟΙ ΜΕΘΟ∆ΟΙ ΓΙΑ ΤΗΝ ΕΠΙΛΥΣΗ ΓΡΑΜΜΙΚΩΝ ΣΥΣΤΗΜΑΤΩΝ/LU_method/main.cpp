...
int main(void) 
{
    ...
    readingData(A,b);                                                         //Diabazoume ta dedomena 
    ...
    InverseMatrix(A, A_inverse);                                              //Briskoume ton antistrofo tou A xrhsimopoiwntas thn LU methodo
    ...
    x = solveLinearSystem(A, b);                                              //Lunoume to susthma Ax = b
    ...
    cout << endl << "A is: " << endl;
    print_Array(A);                                                           //Tupwnoume ton A
    cout << endl << "Inverse of A is: " << endl;
    print_Array(A_inverse);                                                   //Tupwnoume ton antistrofo tou A
